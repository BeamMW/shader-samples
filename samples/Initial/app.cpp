...
{
	_INITIAL_CONTRACT_::InitialParams params;

	Env::GenerateKernel(nullptr, _INITIAL_CONTRACT_::InitialParams::METHOD, &params, sizeof(params), nullptr, 0, nullptr, 0, "Create _INITIAL_CONTRACT_ contract", 0);
}

void On_action_destroy_contract(const ContractID& cid)
{
	Env::GenerateKernel(&cid, 1, nullptr, 0, nullptr, 0, nullptr, 0, "Destroy _INITIAL_CONTRACT_ contract", 0);
}

void On_action_view_contracts(const ContractID& unused)
{
	EnumAndDumpContracts(_INITIAL_CONTRACT_::s_SID);
}
